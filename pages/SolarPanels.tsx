...
import { Download, Sun, Shield, Zap, FileText, CheckCircle } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 gap-6">
              {[
                { title: 'N-Type TOPCon Technology', desc: 'Lower LID/LeTID and better weak illumination response.' },
                { title: 'Bifacial Energy Yield', desc: 'Up to 30% additional power generation from the rear side.' },
                { title: 'Enhanced Mechanical Load', desc: 'Certified to withstand 5400Pa snow load and 2400Pa wind load.' },
                { title: 'PID Resistant', desc: 'Excellent anti-PID performance guaranteed via optimized mass-production process.' }
              ].map((item, i) => (
          ...
          <div className="overflow-x-auto shadow-xl rounded-sm">
            <table className="w-full bg-white border-collapse">
              <thead className="bg-primary text-white">
                <tr>
                  <th className="p-5 text-left text-sm font-bold uppercase tracking-wider">Model Type</th>
                  <th className="p-5 text-left text-sm font-bold uppercase tracking-wider">AES-550M</th>
                  <th className="p-5 text-left text-sm font-bold uppercase tracking-wider">AES-670N</th>
                  <th className="p-5 text-left text-sm font-bold uppercase tracking-wider text-secondary">AES-700N</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-100 text-sm text-gray-700">
                <tr>
                  <td className="p-5 font-bold bg-gray-50">Max Power Output (Pmax)</td>
                  <td className="p-5">550 W</td>
                  <td className="p-5">670 W</td>
                  <td className="p-5 font-bold text-primary">700 W</td>
                </tr>
                <tr>
                  <td className="p-5 font-bold bg-gray-50">Module Efficiency</td>
                  <td className="p-5">21.5%</td>
                  <td className="p-5">22.3%</td>
                  <td className="p-5 font-bold text-primary">22.8%</td>
                </tr>
                <tr>
                  <td className="p-5 font-bold bg-gray-50">Dimensions (mm)</td>
                  <td className="p-5">2279 x 1134 x 35</td>
                  <td className="p-5">2384 x 1303 x 33</td>
                  <td className="p-5">2384 x 1303 x 33</td>
                </tr>
                <tr>
                  <td className="p-5 font-bold bg-gray-50">Weight</td>
                  <td className="p-5">28.6 kg</td>
                  <td className="p-5">33.5 kg</td>
                  <td className="p-5">34.0 kg</td>
                </tr>
                <tr>
                  <td className="p-5 font-bold bg-gray-50">Cell Type</td>
                  <td className="p-5">P-Type PERC</td>
                  <td className="p-5">N-Type TOPCon</td>
                  <td className="p-5">N-Type TOPCon</td>
                </tr>
              </tbody>
            </table>
